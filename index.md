...
- 13:30 - 16:30; Single Cell RNASeq 'taster'
  ...
  + [Single cell population ID](SingleCell/slides/crukSummerSchoolJuly2018_scRnaSeqCellPopId_slides.html)
  + [Single cell PopId Practical(Rmd file)](SingleCell/practical/crukSummerSchoolJuly2018_scRnaSeqCellPopId_practical.Rmd)

NB We do not have sufficient time to teach this entire course in half a day. However, some concepts are covered in the Bulk RNASeq course and we provide the [link to the full materials](https://hemberg-lab.github.io/scRNA.seq.course/index.html). We will teach topics such as PCA which should be of interest even to those not interested in single-cell work.
